...
//
// OJO: el nombre empieza con "_" para que Vercel NO lo cuente como
// función aparte (el plan Hobby permite máximo 12). Se ejecuta a
// través de /api/create-checkout con { action: 'welcome_code' }.
//
